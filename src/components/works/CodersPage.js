            ...
            <main>
                <div className='container container1 center'>
                    <div className='problem'>
                        ...
                        <p className='desc'>If Korean high school and college students aren't proficient in English or don't have access to hagwons, they have difficulties in studying coding, understanding how it works, getting practical information needed to create what they want.</p>
                    </div>
                    
                    <div className='solution'>
                        <h4 className='heading'>The Solution</h4>
                        <h5>First code, then study</h5>
                        <p className='desc'>Coders is a platform that aims to help Korean high school and college students who want to learn coding by allowing them to learn as they code real projects in their spare time. In coders, to help students have fun and understand what they are creating, we let students decide what projects they would like to create.</p>
                    </div>
                </div>
                    ...
                    <div className='product-container center'>
                        <div className='product product1'>
                            ...
                            <div className='product-desc'>
                                ...
                                <p className='desc'>Whenever and where ever you are, either on the subway or walking on the street, you can open up coders and easily study and code your project.</p>
                            </div>
                        </div>
                        ...
                        <div className='product product1'>
                            ...
                            <div className='product-desc'>
                                ...
                                <p className='desc'>Before you get started with coding your project, study the concepts you are going to use and review the concepts you have just learned through quizzes!</p>
                            </div>
                        </div>
                        ...
                        <div className='product product1'>
                            ...
                            <div className='product-desc'>
                                ...
                                <p className='desc'>Click index.html tab or swipe left to see the current code’s output result. Ask any questions that are related to the current topic. Also, don't forget to view what you've coded so far in your browser!</p>
                            </div>
                        </div>
                ...
                <div className='container container3'>
                    ...
                    <p className='desc center'>From the beginning, I wanted to take a different approach to how to study coding. I wanted to learn what intrigues and excites users when they learn to code, so I interviewed 5 people about how and why they study coding.</p>

                    <div className='interview-container center'>
                        <h6 className='question coders-color'>What frustrates you with studying coding?</h6>
                        <p className='answer'>I don’t know where to start. What do I need to create what I want?</p>
                        <p className='demographic'>Student, 19 - 24</p>

                        <h6 className='question coders-color'>What do you want to achieve from learning coding?</h6>
                        ...
                        <p className='answer'>Understanding programming and having fun while coding and developing projects. Also getting fast feedback. </p>
                        <p className='demographic'>Student, 19 - 24</p>
                    </div>
                    ...
                    <div className='insight-container coders-bg-2'>
                        <div className='insights center'>
                            ...
                            <ol className='no-bullets'>
                                <li>As tech is becoming more important in life, students feel the need to learn code to prepare for their future</li>
                    ...
                    <div className='persona-container center'>
                        ...
                        <p className='desc'>Based on my research and secondary research on the learning environment in Korea, I created two user personas to identify key pain points of the users.</p>

                        <ProgressiveImage src='https://ashleyheo-portfolio.s3.ap-northeast-2.amazonaws.com/works/coders/persona1.png' placeholder="https://ashleyheo-portfolio.s3.ap-northeast-2.amazonaws.com/works/coders/persona1-small.png">
                            {(src, loading) => <img className='persona persona1' style={{ filter: loading ? "blur(10px)" : 'none', transition: loading ? "none" : "filter 0.2s ease-out" }} src={src} alt='coders' />}
                        </ProgressiveImage>

                        <ProgressiveImage src='https://ashleyheo-portfolio.s3.ap-northeast-2.amazonaws.com/works/coders/persona2.png' placeholder="https://ashleyheo-portfolio.s3.ap-northeast-2.amazonaws.com/works/coders/persona2-small.png">
                            {(src, loading) => <img className='persona persona2' style={{ filter: loading ? "blur(10px)" : 'none', transition: loading ? "none" : "filter 0.2s ease-out" }} src={src} alt='coders' />}
                        </ProgressiveImage>
                    </div>
                </div>
                <iframe src="https://www.youtube.com/embed/igpg8tLsURE" title="YouTube video player" frameBorder="0" scrolling="no" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </main>
            <Footer title={ "coders" } />
        </div>
    );
